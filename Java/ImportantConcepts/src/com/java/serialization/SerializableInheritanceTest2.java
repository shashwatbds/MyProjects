...
import com.java.beans.ChildWithNotSerializableParent;

public class SerializableInheritanceTest2 {
	...
	private static void deserialize() {
		...
		try(InputStream fin = new FileInputStream("sercont.txt");
			...
			ChildWithNotSerializableParent country = (ChildWithNotSerializableParent) oin.readObject();//Constructor is not called during de-serialisation process.
	...
	private static void serialize() {
		//Serialise
		ChildWithNotSerializableParent c1 = new ChildWithNotSerializableParent();
