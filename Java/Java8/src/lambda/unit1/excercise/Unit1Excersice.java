package lambda.unit1.excercise;
...
public class Unit1Excersice {
	...
	public static void main(String[] args) {
		...
		printPeople(people, p -> p.getlName().startsWith("D"));
	}

	public static void printPeople(List<Person> people, Predicate<Person> predicate) {
		for(Person p : people) {
			if(predicate.test(p)) {
